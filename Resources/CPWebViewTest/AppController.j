...
- (void)applicationDidFinishLaunching:(CPNotification)aNotification
{
    ...
    [webView1 loadHTMLString:"<html><body style='background-color:transparent'><p>This web view should have a coloured background.</p><img src='//avatars3.githubusercontent.com/u/16595'><img src='//avatars3.githubusercontent.com/u/16595'></body></html>"];
    [webView1 setBackgroundColor:[CPColor orangeColor]];

    [webView2 setScrollMode:CPWebViewScrollNative];
    [webView2 loadHTMLString:"<html><body style='background-color:transparent'><p>This web view should be transparent.</p><img src='//avatars3.githubusercontent.com/u/16595'><img src='//avatars3.githubusercontent.com/u/16595'></body></html>"];
    ...
    */
    ...
    [webView5 setMainFrameURL:"//github.com/cappuccino"];

    [webView6 setScrollMode:CPWebViewScrollAppKit];
    [webView6 setMainFrameURL:"//github.com/cappuccino"];
}
